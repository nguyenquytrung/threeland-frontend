    ...
    <div className='px-[24px] min-[900px]:px-[100px] relative'>
      <div>
        <div className='flex self-center'>
          <h1 className='min-[900px]:text-[56px] text-[28px] font-bold'>
            Our activities
          </h1>
            ...
            <div key={index}>
              ...
              >
                ...
                <div className='flex my-4'>
                  ...
                  <p className={`text-['#6A7373'] self-center`}>{item?.time}</p>
                </div>
                ...
                <div
                  ...
                  className={`flex gap-2 items-center justify-center bg-[${
                    ...
                    index === 0 ? '0px' : '1px'
                  }] border-[#9CA1A2] rounded-full p-[10px 24px 10px 24px] w-[177px] h-[48px] text-[${
                    index === 0 ? '#fff' : '#071516'
                  }] mt-4`}
                >

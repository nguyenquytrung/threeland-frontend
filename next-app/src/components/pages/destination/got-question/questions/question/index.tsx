...
const Question = (props: Props) => {
  ...
  const { index, question, answer, id, open, arrayAnswer } = item;
    ...
    <div className="flex gap-8 bg-white p-4">
      ...
      <div className="flex-1">
        <div className="flex justify-between items-center">
          ...
          <h4
            className={` ${isDestination
              ? "flex-1 text-[18px] text-[#394445] leading-[40px] text-justify pl-10"
              : "text-[20px] text-[rgba(7,21,22,1)] font-medium"
              }`}
          >
            {question}
          </h4>
        ...
        >
          {answer ? answer : arrayAnswer.map((_item: any) => {
            return (
              <p key={_item.name}>
